...
w2csv = [ 
	['margin data', ROOT_PATH+'/www/data/margin_data', mdata, mdata_headers],
	['cumulative data', ROOT_PATH+'/www/data/cumulative_data', cdata, cdata_headers],
]
for el in w2csv:
...
print2('Writing last dataset to JSON')

csvFilePath = "www/data/margin_data_last.csv"
jsonFilePath = "www/data/margin_data_last.json"
...
print2('Writing cumulative dataset to JSON')

csvFilePath = "www/data/cumulative_data_last.csv"
jsonFilePath = "www/data/cumulative_data_last.json"
